...
/**
 * Strings for component 'theme_arialist', language 'cs', branch 'MOODLE_23_STABLE'
 *
...
$string['configtitle'] = 'Nastavení motivu Arialist';
...
$string['linkcolor'] = 'Barva odkazu';
$string['linkcolordesc'] = 'Nastavuje barvu odkazů';
$string['logo'] = 'Logo';
$string['logodesc'] = 'Vložte URL obrázku, který bude použit jako logo těchto stránek.';
