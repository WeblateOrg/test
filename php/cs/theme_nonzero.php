...
/**
 * Strings for component 'theme_nonzero', language 'cs', branch 'MOODLE_23_STABLE'
 *
...
$string['configtitle'] = 'Nastavení motivu Nonzero';
...
$string['regionpostwidth'] = 'Šířka pravého sloupce';
$string['regionpostwidthdesc'] = 'Nastavuje šířku oblasti, která vizuálně tvoří pravý sloupec.';
$string['regionprewidth'] = 'Šířka levého sloupce';
$string['regionprewidthdesc'] = 'Nastavuje šířku oblasti, která vizuálně tvoří levý sloupec. Při rozložení typu "blog" se tato oblast zobrazuje uprostřed stránky';
