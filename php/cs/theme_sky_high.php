...
/**
 * Strings for component 'theme_sky_high', language 'cs', branch 'MOODLE_23_STABLE'
 *
...
$string['configtitle'] = 'Nastavení motivu Sky high';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'URL obrázku, který bude použit jako logo těchto stránek. Doporučená výška obrázku je cca 50 px.';
$string['pluginname'] = 'Sky high';
$string['region-side-post'] = 'Vpravo';
$string['region-side-pre'] = 'Vlevo';
$string['regionwidth'] = 'Šířka sloupce';
$string['regionwidthdesc'] = 'Nastavuje šířku dvou bloků, které vizuálně tvoří pravý a levý sloupec.';
