...
/**
 * Strings for component 'theme_splash', language 'cs', branch 'MOODLE_23_STABLE'
 *
...
$string['configtitle'] = 'Nastavení motivu Splash';
$string['customcss'] = 'Vlastní CSS';
$string['customcssdesc'] = 'Sem vložené CSS bude použito na každé stránce. Tím lze snadno přizpůsobovat tento motiv.';
$string['defaulttagline'] = 'Virtuální vzdělávací centrum';
$string['footnote'] = 'Poznámka pod čarou';
$string['footnotedesc'] = 'Vložený obsah bude zobrazován v záhlaví každé stránky.';
$string['hide_tagline'] = 'Skrýt slogan';
$string['hide_taglinedesc'] = 'Zaškrtněte, pokud chcete skrýt slogan pod logem.';
$string['loginhere'] = 'Přihlaste se zde!';
$string['logo'] = 'Logo';
$string['logodesc'] = 'URL obrázku, který bude použit jako logo těchto stránek. Doporučená výška obrázku je cca 230 px.';
$string['pluginname'] = 'Splash';
$string['region-side-post'] = 'Vpravo';
$string['region-side-pre'] = 'Vlevo';
$string['tagline'] = 'Slogan';
$string['taglinedesc'] = 'Krátký slogan, který se zobrazí pod názvem stránek na titulní stránce.';
$string['usergreeting'] = 'Zdravím {$a}!';
$string['welcome'] = 'Vítejte, {$a}';
