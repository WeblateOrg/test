...
/**
 * Strings for component 'theme_standardold', language 'cs', branch 'MOODLE_23_STABLE'
 *
...
$string['pluginname'] = 'Standard (zpětně kompatibilní)';
